package com.hkc.mdw.common.dao.jdbc;
 ...
 * 
 * <p>Project:hkcmdw</p>
 * <p>Package:com.hkc.mdw.common.dao.jdbc</p>
 * <p>Title: MDWJdbcDao</p>
 * <p>Description: </p>
 ...
 * @since jdk1.7.0_80
 * @see
 * Create Time：Sep 15, 201711:56:53 AM
 * Modified By: 
 * Modified Time:
 */
@Repository("mdwjdbcDao")
public class MDWJdbcDao extends SimpleJdbcTemplate{
	...
	@Autowired
	public MDWJdbcDao(DataSource mdwDataSource) {
		super(mdwDataSource);
	}
